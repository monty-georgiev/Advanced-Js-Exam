...
(function (eventSystem) {
    ...
    var select = document.getElementById('halls'),
        numberOfHalls = eventSystem.halls.length,
        counter = 0,
        optionsFragment = document.createDocumentFragment();

    for (counter; counter < numberOfHalls; counter++) {
        var option = document.createElement('option'),
            currentHall = eventSystem.halls[counter];

        option.value = currentHall._name;
        option.innerHTML = currentHall._name;
